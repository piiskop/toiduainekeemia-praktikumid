...
Siinses raportis käsitletavate toiduainekeemia kursuse praktikumide kirjeldused lähtuvad minu, peacecop kalmeri:, vaatenurgast. Tallinna Ülikoolis on mu üliõpilaskood *210951MLLB.LT*, mis on seotud isikuga Kalmer Piiskop. Kuigi praktikumitöö vormistamise juhendis on kirjas, et tuleb kasutada umbisikulist tegumoodi, kirjutan ma, nagu mainitud, oma vaatenurgast, seega mitte umbisikuliselt. Kui kasutada umbisikulist tegumoodi, võib tekkida arusaam, et keegi suvaline inimene tegi, kuigi tegid konkreetsed inimesed. Seetõttu stiil *teadlased avastasid* või *avastati* ei ole minu hinnangul kohane, kui tahame, et väide oleks usaldusväärne. Protokollist peab ikka olema võimalik täpselt välja lugeda, kes mida kus millal tegi. See pole ilukirjanduslik teos, milles kirjeldatakse tausta. Minu stiil on selline ja kui mind just ei veenda põhjapanevate argumentidega seda muutma, siis ma jään selle juurde.
