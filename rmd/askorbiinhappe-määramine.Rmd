...
C-itamiini sisalduse kontrollimise oskus omandatud.
...
12. Lasen arvutada kaaliumjodaadi lahuse molaarsuse.
    ...
    ```{r label = "calculating-molarity-of-KIO3"}
...
13. Testimiseks valisime *Suukaudse pihusti C-vitamiini*. Lasen arvutada selleks vajaliku lahusti mahu arvestades, et muud kogused jäävad samaks:
    ...
    ```{r label = "calculating-volume-of-C-in-spray"}
...
14. Mõõtsime tühja \num{250}-\unit{\ml} Erlenmeyeri kolbi \qty{150}{\ml} vett.
    ...
    ```{r label = "volume-of-C-in-spray-for-titration"}
...
17. Kolbi valmistatud lahust tiitrisime \qty{`r as.character(volume_of_KIO3_for_spray)`}{\ml} kaaliumjodaadiga.
    ...
    ```{r label = "volume-of-KIO3-for-spray-used"}
...
18. Lasen arvutada meie väljaselgitatud C-vitamiini koguse viies pihustidoosis ja võrdlen pakendile märgituga:
    ...
    ```{r label = "ratio-of-mass-of-C-experimental-to-theoretical"}
