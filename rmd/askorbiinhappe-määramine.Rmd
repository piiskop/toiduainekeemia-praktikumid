...
13. Testimiseks valisime *Suukaudse pihusti C-vitamiini*. Arvutasime selleks vajaliku lahusti mahu:
    
    ```{r label = "calculating-volume-of-C-in-spray"}
    amount_of_KIO3_for_spray <- 10 * molarity_of_KIO3
    amount_of_C_in_spray <- amount_of_KIO3_for_spray * 3
    mass_of_C_in_spray_for_titration <- amount_of_C_in_spray * relative_atomic_mass_of_C
    volume_of_C_in_spray <- mass_of_C_in_spray * 5 / mass_of_C_in_spray_for_titration
    
    ```
    
    Pihustasime testtoodet \num{`r as.character(number_of_sprays)`} lasku \qty{`r as.character(volume_of_C_in_spray)`}{\ml} vette.

14. Mõõtsime tühja \num{250}-\unit{\ml} Erlenmeyeri kolbi \qty{150}{\ml} vett.

15. Mõõtsime samasse kolbi \qty{`r as.character(volume_of_C)`}{\ml} C-vitamiini sammul \num{13} valmistatud pihustilahust.
