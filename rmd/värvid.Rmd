...
Valem \@ref(eq:K) leheküljel `r render_pageref(reference = "eq:K")` on minu jaoks ebaselge. Ei leitud sellist valemit ka Internetist. Eriti ebaselgeks teeb selle valemi asjaolu, et kõik ühikud taanduvad, aga ometi tahetakse vastavalt juhendile ühikuks määrata milligrammprotsenti. See ühik - milligrammprotsenti - näitab, mitu milligrammi $\beta$-karoteeni on \qty{100}{\mg} uuritavas proovis. Nüüd saan ma küll aru, miks milligrammprotsenti võib olla ka ühikuta, sest see on milligrammid jagatuna milligrammidega. Samas, Wikipedias arutletakse, et mõeldud oli kontsentratsiooni massiühikutes ruumalaühiku kohta, kuid ebakorrektselt[@a2021_milligram], sest korrektne selgitus tähendaks hoopis sajandikku milligrammi. Aga sellises juhus ei ole valem korrektne.
